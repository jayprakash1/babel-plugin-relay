...
/***/ function(module, exports, __webpack_require__) {
	...
	function compileRelayQLTag(t, path, schemaProvider, quasi, documentName, propName, tagName, enableValidation, state) {
	  try {
	    ...
	    var transformer = __webpack_require__(21)(schemaProvider, state.opts || {}, fileOpts);
	    ...
	    throw path.buildCodeFrameError(__webpack_require__(20)(error), Error);
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createAST(t, state, path, graphqlDefinition) {
	  ...
	  var modernNode = __webpack_require__(19)(t, graphqlDefinition, isHasteMode);
	  if (isCompatMode) {
	    return __webpack_require__(18)(t, modernNode, __webpack_require__(17)(t, path, graphqlDefinition, state));
	  }
	  return modernNode;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getSchemaIntrospection(schemaPath, basePath) {
	  try {
	    ...
	    if (!__webpack_require__(13).existsSync(fullSchemaPath) && basePath) {
	      fullSchemaPath = __webpack_require__(29).join(basePath, schemaPath);
	    }
	    var source = __webpack_require__(13).readFileSync(fullSchemaPath, 'utf8');
	    if (source[0] === '{') {
